...
for css in dock-hover-background-hidden.css dock-focused-app-background-hidden.css dash-hover-background-hidden.css dash-focused-app-background.css; do
